...
title: About
permalink: /
subtitle: CS PhD student @ <a href='https://cs.uic.edu/'>University of Illinois Chicago</a>.

profile:
  align: right
  image: prof_pic_siyuan.jpeg
  image_circular: false # crops the image to make it circular
  # more_info: >
  #   <p>Electronic Visualization Laboratory</p>
  #   <p>University of Illinois Chicago</p>
  #   <p>Chicago, IL</p>

selected_papers: true # includes a list of papers marked as "selected={true}"
social: false # social icons now live in the navbar (see `enable_navbar_social` in _config.yml)
